...
import allocation.domain.Curso;
import allocation.domain.Matricula;
import allocation.domain.Usuario;
import allocation.exceptions.CustomRuntimeException;
import allocation.exemplo.ws.MatriculaWs;
import allocation.repositories.MatriculaRepository;
